...
f1=open("Temp1.txt","a")
f1.writelines(["Roll Number : 94","Name : Muhammad Hassan Noorsumar","Class : TYCO5I"])
f1.close()
"""
Output of Use writelines() method to add your roll number, name, and class : 
Roll Number : 94Name : Muhammad Hassan NoorsumarClass : TYCO5I
"""
# In Python Use readines() method to print your data in the prompt
f2=open("Temp2.txt","a")
f2.writelines(["Roll Number : 94 ","Name : Muhammad Hassan Noorsumar ","Class : TYCO5I"])
f2.seek(0)
f2.close()
f3=open("Temp2.txt","r")
print(f3.readline())
...
Roll Number : 94 Name : Muhammad Hassan Noorsumar Class : TYCO5I
"""
